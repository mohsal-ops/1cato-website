        ...
        <div className='flex items-center gap justify-start'>
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
                <SheetTrigger className={`${isMobile && 'absolute right-0 left-0 bottom-0'}`}>
                    <div style={quantity ? { backgroundColor: "#f97316", color: 'white' } : {}} className='flex items-center gap-2 justify-center md:border  px-4 py-2 hover:cursor-pointer rounded-xl  bg-background hover:bg-accent hover:text-accent-foreground'>
                        {isMobile ? (
