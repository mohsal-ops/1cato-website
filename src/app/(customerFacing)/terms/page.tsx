...
export const metadata: Metadata = {
  ...
  description:
    "Terms of service, privacy policy, and ordering policies for 1Cato Snow Cones in Brooklyn, NY.",
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            By accessing and using 1Cato Snow Cones restaurant website and services, you agree to be bound by these terms and conditions.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            The information provided on this website is for informational purposes only. 1Cato Snow Cones makes no representations or warranties of any kind regarding the accuracy or completeness of the content.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700">
            In no event shall 1Cato Snow Cones be liable for any indirect, incidental, special, or consequential damages arising from your use of this website or services.
          </p>
        </section>
        ...
        <section className="border-t pt-8">
          ...
          <p className="text-gray-700">
            If you have any questions about these terms and policies, please contact us at 1catosnowcone@gmail.com
          </p>
        </section>
      </div>
    </div>
