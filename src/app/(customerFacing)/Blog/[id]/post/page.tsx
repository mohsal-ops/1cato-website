...
export const metadata = {
  ...
  description:
    "Discover stories, flavors, and behind-the-scenes from 1Cato Snow Cones – refreshing, gluten-free, fat-free snow cones in Brooklyn, NYC.",
  openGraph: {
    title: "1Cato Snow Cones Journal",
    description: "Stories, culture and food from 1Cato Snow Cones restaurant.",
  },
};
...
export default async function BlogPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0f0f0f] text-white">
          ...
          <>
            <section className="relative h-screen sm:h-[80vh] flex items-end">
              ...
              <div className="relative z-10 p-10 max-w-4xl">
                <span className="uppercase tracking-widest text-[#f97316] text-sm">
                  Featured Story
                </span>
                ...
                <Link
                  ...
                  className="inline-block mt-6 px-6 py-3 bg-[#f97316] text-black font-semibold rounded-full hover:scale-105 transition"
                >
                  Read Story →
                </Link>
              </div>
      ...
      {/* BRAND STATEMENT */}
      <section className="bg-[#f97316] text-black py-20 text-center">
        <h3 className="text-4xl font-bold">
          Naturally refreshing. Guilt-free.
        </h3>
        <p className="mt-4 max-w-2xl mx-auto text-lg">
          Every cone is made with real fruit, premium syrups, and the perfect
          crunch of shaved ice — gluten-free and fat-free.
        </p>
      </section>
