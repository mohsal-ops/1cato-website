...
export default function GiftCardPageClient() {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 space-y-10">
      {/* 🔥 HERO */}
      <section className="relative overflow-hidden rounded-3xl bg-white px-10 py-24 text-center shadow-xl text-orange-500">
        ...
        <div className="relative z-10">
          <div className="flex justify-center mb-6">
            <div className="rounded-2xl bg-orange-500 p-3 shadow-xl">
              <Image src={logo} alt="1Cato Snow Cones" className="h-20 w-auto" />
            </div>
          </div>
          ...
          <p className="mt-6 max-w-2xl mx-auto text-orange-100 text-lg">
            ...
            1Cato Snow Cones gift card instantly.
          </p>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-10 items-center px-6">
        <div className="relative">
          <div className="rounded-2xl bg-linear-to-br from-orange-500 to-orange-400 p-8 shadow-2xl -rotate-3">
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Card className="p-6 space-y-4">
        ...
        <Button
          type="submit"
          className="w-full bg-black text-orange-500 hover:bg-black/90"
        >
          {isLoading
            ? "Processing..."
