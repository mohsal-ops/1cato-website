    ...
    <main className="flex flex-col items-center pt-24 overflow-hidden">
      ...
      <section className="relative w-full h-[90vh] flex items-end justify-start">
        <Image
          ...
          alt="1Cato Snow Cones story hero"
          fill
          priority
        ...
        >
          ...
          >
            ...
            and for the owners of 1Cato Snow Cones, that&apos;s food and family.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section className="w-full max-w-6xl px-6 md:px-12 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            1Cato Snow Cones was born from a passion for sharing authentic,
            heartfelt cuisine with the world bringing together Caribbean-style
            recipes with a distinct Brooklyn flair.
          </p>
          <p className="text-gray-600 text-lg leading-relaxed">
            At the heart of 1Cato Snow Cones is a rich family legacy. Owners
        ...
        >
          <Image
            ...
            alt="The 1Cato Snow Cones experience"
            width={800}
            height={600}
      ...
      <section className="w-full bg-stone-900 text-white py-20 px-6 text-center">
        ...
        >
          <p className="text-2xl md:text-4xl font-bold leading-snug">
            &quot;1Cato Snow Cones is more than a restaurant
          ...
          <p className="mt-6 text-gray-400 text-lg leading-relaxed">
            ...
            the warmth of home-style cooking, 1Cato Snow Cones brings a
            one-of-a-kind fusion of flavor to the Brooklyn market.
          </p>
        </motion.blockquote>
      </section>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              text: "No shortcuts, no compromises. Caribbean flavors done right, every single time because Brooklyn deserves the real thing.",
            },
            {
              icon: "🤝",
      ...
      <section className="w-full max-w-6xl px-6 md:px-12 py-24">
        ...
        >
          <Image
            ...
            alt="1Cato Snow Cones dining experience"
            width={1600}
            height={700}
          ...
          <div className="absolute bottom-0 left-0 p-10 md:p-16 text-white max-w-2xl">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              Brooklyn&apos;s appetite for genuine Caribbean flavor is wide open
              and 1Cato Snow Cones is here to fill it, one unforgettable
              plate at a time.
            </p>
            <a
              href="/Menu"
